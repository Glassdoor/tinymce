tinymce.PluginManager.add("gd_image", function (editor) {
	...
	function showDialog(imageList) {
		...
		var generalFormItems = [
			{
				type: 'label',
				text: 'PNG, JPEG, or GIF: max size 5MB.'
			},
			{
				type: 'label',
				text: 'Images resized to 600px maximum width'
			},
			{
				name: 'src',
				type: 'filepicker',
