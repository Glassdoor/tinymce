...
tinymce.PluginManager.add('gd_media', function(editor, url) {
	var urlPatterns = [
	...
	function showDialog() {
		...
		win = editor.windowManager.open({
			...
			body: [
				{
					type: 'label',
					text: 'Paste an embed code from YouTube or Vimeo'
				},
				{
					type: 'textbox',
					name: 'embed',
				...
				},
				{
					type: 'label',
					multiline: true,
					text: 'Note: It is normal for videos to display as a gray'
				},
				{
					type: 'label',
					text: 'box in the editor'
				}
			],
			onSubmit: function() {
